...
<div class="event_nav_buttons_container">
	...
	if($prev_event_id > 0) {
		...
		?>
        <!-- prev event button -->
		<div class="event_link"><a class="preview_event_button nav_event_button" href="#!event_<?php echo $_GET["year"]; ?>_<?php echo $_GET["month"]; ?>_<?php echo $_GET["day"]; ?>_<?php echo $calendarObj->getCalendarId(); ?>_<?php echo $prev_event_id; ?>_<?php echo urlencode($eventObj->getEventTitle()); ?>" onclick="javascript:openEvent(<?php echo $_GET["year"]; ?>,<?php echo $_GET["month"]; ?>,<?php echo $_GET["day"]; ?>,<?php echo $calendarObj->getCalendarId(); ?>,<?php echo $prev_event_id; ?>)"><?php echo $lang["GETEVENT_PREV_EVENT"]; ?></a></div>
		<?php
	}
	...
	if($next_event_id > 0) {
		...
		?>
        <!-- next event button -->
		<div class="event_link"><a class="preview_event_button nav_event_button" href="#!event_<?php echo $_GET["year"]; ?>_<?php echo $_GET["month"]; ?>_<?php echo $_GET["day"]; ?>_<?php echo $calendarObj->getCalendarId(); ?>_<?php echo $next_event_id; ?>_<?php echo urlencode($eventObj->getEventTitle()); ?>" onclick="javascript:openEvent(<?php echo $_GET["year"]; ?>,<?php echo $_GET["month"]; ?>,<?php echo $_GET["day"]; ?>,<?php echo $calendarObj->getCalendarId(); ?>,<?php echo $next_event_id; ?>)"><?php echo $lang["GETEVENT_NEXT_EVENT"]; ?></a></div>
		<?php 
	}
	?>
...
<script language="javascript" type="text/javascript">
	$(function() {
		...
		$('#text_button').css("background-color","#567BD2");
