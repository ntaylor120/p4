...
<div class="event_nav_buttons_container">
	 <!-- back -->
        <div class="m_event_back float_right"><a href="#" onclick="javascript:getEventsList(<?php echo $_GET["year"]; ?>,<?php echo $_GET["month"]; ?>,<?php echo $_GET["day"]; ?>,<?php echo $calendarObj->getCalendarId(); ?>,<?php echo $pag; ?>);" class="float_right bg_grey_ccc radius mark_grey padding_button_small"><?php echo $lang["GETEVENT_BACK_TO_EVENTS_LIST"]; ?></a></div>
...
<div class="m_calendar_container">
    ...
    <div class="m_event_list_container bg_white">
        ...
        <div class="m_single_event_container">
            ...
            <div class="addthis_toolbox addthis_default_style addthis_32x32_style margin_tb"> 
