...
<div class="event_nav_buttons_container">
	 <!-- back -->
        <div class="m_event_back float_right"><a href="#" onclick="javascript:getEventsHomeList(<?php echo $calendarObj->getCalendarId(); ?>,<?php echo $pag; ?>,'<?php echo $_GET["filter"]; ?>');" class="float_right bg_grey_ccc radius mark_grey padding_button_small"><?php echo $lang["GETEVENT_BACK_TO_EVENTS_LIST"]; ?></a></div>
	
    <!-- close -->
    <div class="m_list_buttons_container padding_small margin_t"><a href="#" class="float_right bebas mark_grey" onclick="javascript:closeHomeEvents(<?php echo $_GET["year"]; ?>,<?php echo $_GET["month"]; ?>,<?php echo $calendarObj->getCalendarId(); ?>);"><?php echo $lang["GETEVENT_CLOSE"]; ?>&nbsp; X</a></div>
        ...
        <div class="m_single_event_container">
            ...
            <?php
				...
				if(count($eventObj->getEventImages())>0) {
					?>
                    <!-- link -->
                    <div class="margin_tb_medium"><a href="mobile/ajax/foto.php?event_id=<?php echo $eventObj->getEventId(); ?>" class="bg_black mark_white padding_button_small bebas m_link_button"><?php echo $lang["GETEVENT_GALLERY"]; ?></a></div>
                    <?php
				}
				?>
                <?php
				if($eventObj->getEventVideo()!='') {
            		...
            		<div class="margin_tb_medium"><a href="mobile/ajax/video.php?event_id=<?php echo $eventObj->getEventId(); ?>" class="bg_black mark_white padding_button_small bebas m_link_button"><?php echo $lang["GETEVENT_VIDEO"]; ?></a></div>
                    <?php
				}
				?>
                <?php
				if($eventObj->getEventMap()!='') {
            		...
            		<div class="margin_tb_medium"><a href="mobile/ajax/map.php?event_id=<?php echo $eventObj->getEventId(); ?>" class="bg_black mark_white padding_button_small bebas m_link_button"><?php echo $lang["GETEVENT_MAP"]; ?></a></div>
                    <?php
				}
				?>
            	<?php
				if($eventObj->getEventHashtag()!='') {
					?>
            		<div class="margin_tb_medium"><a href="mobile/ajax/twitter.php?event_id=<?php echo $eventObj->getEventId(); ?>" class="bg_black mark_white padding_button_small bebas m_link_button">twitter</a></div>
                    <?php
				}
				?>
            	<?php
				if($settingObj->getFlickrApiKey()!='' && $eventObj->getEventFlickrSearch()!='') {
					?>
            		<div class="margin_tb_medium"><a href="mobile/ajax/flickr.php?event_id=<?php echo $eventObj->getEventId(); ?>" class="bg_black mark_white padding_button_small bebas m_link_button">flickr</a></div>
                    <?php
				}
				?>
