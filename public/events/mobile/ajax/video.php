...
<div class="m_month_navigation_container float_left" style="margin-bottom: 10px;">
    ...
    <div class="m_month_container float_left bg_black" id="month_label">
        <div class="month_name mark_white bebas font_medium" id="month_name"><?php echo $lang["GETEVENT_VIDEO"]; ?></div>
    </div>
...
<div style="margin:auto;text-align:center"><?php echo $eventObj->getEventVideo(); ?><br /><?php echo $eventObj->getEventVideoText(); ?></div>
